target_compile_options(${PROJECT_NAME} PUBLIC -sUSE_SDL=2 -sUSE_SDL_IMAGE=2 -sUSE_SDL_TTF=2 -sUSE_SDL_MIXER=2 -g -Wno-switch)
    target_link_libraries(${PROJECT_NAME} -sLEGACY_GL_EMULATION=1 -sGL_UNSAFE_OPTS=1 -sERROR_ON_UNDEFINED_SYMBOLS=0 -sUSE_SDL=2 -sUSE_SDL_IMAGE=2 -sUSE_SDL_TTF=2 -sUSE_SDL_MIXER=2)
...
set_target_properties("${PROJECT_NAME}" PROPERTIES LINK_FLAGS "-s ASSERTIONS -s GL_ASSERTIONS -s GL_DEBUG -s DEMANGLE_SUPPORT=1 -s OFFSCREEN_FRAMEBUFFER=1 -s ALLOW_MEMORY_GROWTH -s EXIT_RUNTIME=1 -s SDL2_IMAGE_FORMATS='[\"png\"]' --preload-file \"${CMAKE_SOURCE_DIR}/resources\"@resources --shell-file \"${CMAKE_CURRENT_BINARY_DIR}/shell.html.in\"")
